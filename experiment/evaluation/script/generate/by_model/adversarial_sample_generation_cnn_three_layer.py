...
if __name__ == "__main__":
    ...
    for i in range(NUM_SAMPLES):
        ...
        if SAVE_IMAGE:
            transforms.ToPILImage()(image.squeeze(0)).save(os.path.join(SAVE_IMAGE_PATH, "cnn_three_layer_original_" + str(i) + ".png"))
            transforms.ToPILImage()(image_untargeted.squeeze(0)).save(os.path.join(SAVE_IMAGE_PATH, "cnn_three_layer_itfgsm_" + str(i) + ".png"))
            transforms.ToPILImage()(image_stealthy_untargeted.squeeze(0)).save(os.path.join(SAVE_IMAGE_PATH, "cnn_three_layer_mt_itfgsm_" + str(i) + ".png"))
